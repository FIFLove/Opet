  ...
  <div class="header">
    ...
    <div class="board_area">
        <div class="board_box_1">
                <form action="salewrite_ok.php" method="post" enctype="multipart/form-data">
                    <div class="board_box_2">
                        <input type = "text" class = "title" placeholder="판매게시판" disabled>
                    </div>
                    <div class="board_box_2">
                        <input type ="text" name="title" class = "title" placeholder="상품명을 입력해주세요." maxlength="30" required><hr/>
                        <input type ="text" name="cost" class = "title" placeholder="가격을 입력해주세요." maxlength="30" required><hr/>
