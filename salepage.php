...
<head>
  <meta charset="UTF-8">
  <title>OPetGG</title>
  <link rel="stylesheet" href="css/pagelist.css?after"/>
</head>
<body>
  <!--헤더-->
  <div class="header">
  ...
  <div class="pagetop">
    <div class="postnamebox">
      <div class="postname"><strong>판매게시판</strong></div>
      <div class="postnameeng"><strong>SALE POST</strong></div>
    </div>
    <div class="rightbar" style="background-color: skyblue;"></div>
    <div class="leftbar"></div>
    <img class="postimage" src="../img/pawinhand/hero_adapt.png" alt="">
  </div>
      <a href="salewrite.php" ><button class="write_btn"> 글쓰기 </button></a>
    <br />
    <br />
  <div class = "postlist">
  <ul class = "cf">
    <?php
      ...
      $posts = select("SELECT * FROM (SELECT * FROM post WHERE POSTTYPE='SALE' ORDER BY IDX DESC) WHERE ROWNUM <= 8");
      ...
      foreach ($posts as $post)
      {
        ...
        ?>
        <a href="saleread.php?idx=<?php echo $post["IDX"];?>">
        <li class = "postitem">
          <div class="thumbbox">
