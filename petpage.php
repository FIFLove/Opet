...
<body>
  ...
  <div class="pagetop">
    <div class="postnamebox">
      <div class="postname"><strong>동물게시판</strong></div>
      <div class="postnameeng"><strong>PET POST</strong></div>
    </div>
    <div class="rightbar" style="background-color: yellowgreen;"></div>
    <div class="leftbar"></div>
    <img class="postimage" src="../img/pawinhand/hero_adapt.png" alt="">
  </div>
      <a href="petwrite.php" ><button class="write_btn"> 글쓰기 </button></a>
    <br />
    <br />
  <div class = "postlist">
  <ul class = "cf">
    <?php
      ...
      $posts = select("SELECT * FROM (SELECT * FROM post WHERE POSTTYPE='PET' ORDER BY IDX DESC) WHERE ROWNUM <= 8");
      ...
      foreach ($posts as $post)
      {
        ...
        ?>
        <a href="petread.php?idx=<?php echo $post["IDX"];?>">
        <li class = "postitem">
          <div class="thumbbox">
